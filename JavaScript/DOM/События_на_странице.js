 ...
 * 'resize' - Сробптывает при изменении экрана (Вешать только на window)
 * orientationchange - возникает каждый раз, когда устройство изменяет ориентацию экрана и самого себя,
